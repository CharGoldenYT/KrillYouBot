#DONT USE THIS, THIS IS JUST HERE FOR REFERENCING CODE.

import discord,atexit,os,random,shutil,maskpass
from os import system
system('title Krill You Bot | A discord bot to krill your friends!')
from modules.krillcommand import getKrillMessage
from modules.getCurVersion import getCurVersion, get_filname
from modules.betterLogs.betterLogs import *
...
from modules.generateStrings import get_readme,get_privacy_policy,get_tos,get_gitVer,make_author_string,ver,make_changelog
...
try:client.run(botKey)
    ...
    log_fatal(filname, f'[STARTUP]: Invalid Bot Key or generic error!! got: "{botKey}" with an error of {str(e)}', False) # added quotes to make it more obvious what went wrong in the case of a resume session failing